...
import { Send, Mic, MicOff, Bot, User, Heart, Sparkles, Volume2, VolumeX } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        {/* Chat Header */}
        <div className="bg-gradient-to-r from-gray-50 to-primary-50 p-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-to-r from-primary-500 to-healing-500 rounded-full flex items-center justify-center">
        ...
        <div className="h-96 overflow-y-auto p-4 space-y-4">
          {messages.length === 0 && (
            <div className="text-center py-8">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                className="w-16 h-16 bg-gradient-to-r from-primary-500 to-healing-500 rounded-full flex items-center justify-center mx-auto mb-4"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-md mx-auto">
                {conversationStarters.map((starter, index) => (
                  <motion.button
                    ...
                    className="p-3 text-sm bg-primary-50 text-primary-700 rounded-lg hover:bg-primary-100 transition-colors"
                ...
                <div className={`flex items-start space-x-3 max-w-xs lg:max-w-md ${
                  ...
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    message.role === 'user' 
                      ...
                      : 'bg-gradient-to-r from-healing-500 to-primary-500 text-white'
                  }`}>
          ...
          {isProcessing && (
            ...
            >
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-gradient-to-r from-healing-500 to-primary-500 rounded-full flex items-center justify-center">
        ...
        <div className="border-t border-gray-200 p-4">
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="p-3 bg-gradient-to-r from-primary-500 to-healing-500 text-white rounded-xl hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <motion.div
          ...
          className="bg-white rounded-xl p-6 shadow-lg border border-gray-100"
        >
          <div className="w-12 h-12 bg-gradient-to-r from-healing-500 to-healing-600 rounded-xl flex items-center justify-center mb-4">
        ...
        <motion.div
          ...
          className="bg-white rounded-xl p-6 shadow-lg border border-gray-100"
        >
          <div className="w-12 h-12 bg-gradient-to-r from-warm-500 to-warm-600 rounded-xl flex items-center justify-center mb-4">
